// 🎯 CARRUSEL Y MODAL PARA MKVs.html
// TurbioLagann Web - JavaScript para la sección MKVs

let slideIndex = 0;
const images = [
    { src: '../Imagenes/MKVs/1.png'},
    { src: '../Imagenes/MKVs/2.png'},
    { src: '../Imagenes/MKVs/3.png'},
    { src: '../Imagenes/MKVs/4.png'},
    { src: '../Imagenes/MKVs/5.png'},
    { src: '../Imagenes/MKVs/6.png'},
    { src: '../Imagenes/MKVs/7.png'},
    { src: '../Imagenes/MKVs/8.png'},
